    ...
    <>
      <div className="container d-flex flex-row justify-content-center alig-items-center mt-3 w-50">
        <form className="d-flex" action="" onSubmit={(e)=>{handleGetPokemonInfo(pokemon,e)}}>
          <input type="text" className="form-control me-2" placeholder="En minuscula xfa" onChange={(e)=>{setPokemon(e.target.value)}} />
          <input type="submit" value="Buscar Pokemon" className="btn btn-danger" />
